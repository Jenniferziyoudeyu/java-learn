...
//        System.out.println(lastOccurIndex);
        ...
        KCloestInSortedArray kCloset = new KCloestInSortedArray();
        int []kClosetNum = kCloset.kClosest(occurArray, 5,3);
        for (int i = 0; i < kClosetNum.length; i++) {
            System.out.print(kClosetNum[i] + ",");
        }
